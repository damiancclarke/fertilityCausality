...
\pgfplotstableset{create on use/error/.style={
    creaate col/expr={\thisrow{uci}-\thisrow{beta}
      a}}}
...
%===============================================================================
\title{Children and Their Parents\\ A Review of Fertility and Causality}
...
\indent \hspace{1mm} \textbf{Keywords}: Fertility, causality, childbirth, contraceptives. \\
...
in precisely these circumstances. %R1.
These include both fully structural estimation strategies, as well as
reduced-form methods such as the use of instrumental variables (IV), combining
difference-in-difference (DD) with IV, the use of quasi-experimental fertility
shocks, or trying to artificially construct a treatment and control group
using family members or other matching methods.  In the sections which follow,
I describe these methodologies, the empirical results they have given rise to,
and the identifying assumptions that motivate causality in each case.  I also
discuss common threats to inference, and what, if anything, these threats
imply with regard to the existing estimates in the fertility literature.
...
physical sciences, demography and medicine, and in many sub-fields within 
...
discussion of teenage childbearing and its determinants in the USA, 
...
provide extremely useful reviews of these particular areas of the literature. The
handbook chapter of \citet{Schultz2008} is perhaps the definitive reference for
microeconomists interested in an analysis with a very broad scope. There are many
papers discussing education and fertility (ie \citet{Blacketal2008}), which won't
be discussed in this paper.}, the macroeconomic effects \citep{Enke1966,Enke1971}, 
...
\end{equation}
For now we make no distinction between different 
values of $b$ in (\ref{Feqn:estimand}).  Generally however, we will be interested 
in at least two separate situations. The first, comparing having any children 
...
human well-being.  I discuss these `whys' in what remains of this section.
...
roots, including biological, (for example, the \citet{TriversWillard1973}
...
current World Health Organisation definition of reproductive rights. 
...
to access desired contraceptive technologies.\footnote{Recent estimates 
  \citep{BongaartsSinding2011}, suggest that approximately 40\% of pregnancies in
...
\subsection{Theory, Empirics, and their Interaction}
While a theoretical result, a number of articles---both historically and more
recently---provide empirical support for the QQ trade-off when explicitly
starting from the theoretical constructs of \citet{BeckerLewis1973}. These
papers link a utility-maximising child investment decision directly to their
estimation strategy.  A classic example is \citet{RosenzweigWolpin1980}'s work
in resolving the prevailing intractabilities in estimating parameters from
\citet{BeckerLewis1973}'s QQ model.  While most recognised as the introduction
of the twin instrument to the economic literature, this is directly borne from
the restrictions imposed by a utility maximising family jointly optimising
fertility choices with child investment decisions.

Further recent work starts explicitly from a (theoretical) quantity-quality
framework, however aims to loosen the assumptions of early QQ models.
\citet{AizerCunha2012,MogstadWiswall2016} and \citet{Brinchetal2012} all
loosen assumptions regarding: (a) the assumed homogeneity of children or (b)
the assumed homogeneity of parental \emph{response} to all children.  All of
these studies begin with a parental utility function which includes both child
quality and child quantity as competing choices, and indeed, attach a precise
structure to this utility.  However, these utility functions extend earlier
models in permitting heterogeneity over children, the effect of siblings by
birth order, or the way that parents treat children with different endowments.
As in \citet{RosenzweigWolpin1980}, the models proposed by
\citet{AizerCunha2012} and \citet{Brinchetal2012} are linked directly to
estimated specifications, bridging the QQ theory and empirical findings
%R1

Although none of these papers are fully structural, they take seriously the
decisions and restrictions faced by parents in optimising their fertility
choices which were proposed in the earliest QQ models.  This can be pushed
even further in structural papers where estimation strategies \emph{directly}
interact with parental QQ behaviour.  Models of these types have been shown
to have considerable explanatory power in modeling observed fertility and
human capital outcomes, and more importantly, to interact with and explain
behavioural responses to post-birth educational and labour market policies
\citep{ToddWolpin2006}.

More generally, a range
of papers in the \emph{macro}-economic literature examine the effect of
aggregate fertility on human capital attainment and growth.  Papers in this
field---which started with the theoretical work of \citet{BarroBecker1988,
  BarroBecker1989,Beckeretal1990}---link individual decisions over fertility
and child investment to aggregate macro trends in fertility and human capital
(see for example \citet{DelaCroixDoepke2003} and references therein.  These
are also among the central issues examined in
\emph{Family Economics Writ Large} \citep{Greenwoodetal2016}).  While clearly
linking the economic theory of fertility choices and human capital investment
with empirical results, these papers consider national-level measurements, and
as such are not a central part of this review.  An interesting, brief and
cross-cutting overview of much of the original Beckerian QQ theory and its
importance for present work across economic fields is provided by
\citet{Doepke2015}.  However, even when not directly invoked in reduced-form
papers to explain how empirical results owe to optimal family behaviour, QQ
theory casts a long shadow over the ways these papers are set-up and estimated.
The hypothesised effect of fertility on child quality is built directly in to
many reduced-form models. I turn to discuss this work now.
...
cross-sectional data. Early work, such as \citet{Desai1995}, provides 
...
\label{Fsscn:kidIV}
In systems of equations of the type described in section \ref{Fscn:kids}, one
way to drive inference is through the
...
which contains quality on fertility and the instrument must result in a 
...
women are more likeley than healthy women to be infertile or suffer miscarriage,
...
simultaneously occurring phenomena separate treatments from controls.  This is
...
and are potentially divorced from other simultaneous reforms or differential 
trends.
...
of fertility on child outcomes are \citet{Gruberetal1999,Ananatetal2009} and
...
marginal child not born due to pill diffusion looks very different: 8.0\% 
...
who finds that the outlawing of abortion in Romania worsened child 
...
of receipt of treatment on pre-existing characteristics. For example,
...
surrounds the possibility that \emph{local} reforms have more widely spread
...
considerable coverage also provided in the \emph{JPE} Fertility issue described
...
The theoretical results of \citet{Becker1965,Willis1973}, and
\citet{Gronau1973} link additional births with the availability of time---%
particularly of mothers---within the household. A range of structural papers
interact directly with this theory, and bring its implications to estimable
equations related to fertility and maternal labour market decisions.
Seminal papers from \citet{HeckmanWillis1976} and \citet{HotzMiller1988} and
more recent work such as \citet{Francesconi2002} document the important dual
nature of decisions relating to child bearing and labour market.  These
structural papers make very clear the endogeneity in choices of labour supply
and child-bearing/child-rearing decisions.  While the structural approach
seeks to directly model the joint optimisation of parents and families
explicit in economic theory, a second, reduced-form approach seeks to isolate
only the effect of fertility on labour market outcomes.  This requires more
fortuitous identifying information, and is what I turn to discuss in the
remainder of this section.
%a utility function containing a vector of work and child-birth decisions.
%Francesconi Refs: Becker1965,Heckman and Willis 1976, Hotz 1980.
%R1
...
%divorce.}
\citet{AngristEvans1996} report similar estimates for 1970 abortion 
...
probability, particularly of black women.  Other significant outcomes discussed 
...
effects on cohabitation.  Interestingly, the work of \citet{EdlundMachado2015}
shows how simultaneous natural experiments can produce unexpected interactions.
Namely, they document that the invention of the oral contraceptive pill and
allowances for access to young married -- but not young unmarried -- women
resulted in increases in early marriage paired with longer fertility delay
due to pill access, and \emph{higher} human capital accumulation among this
group of women.
%R1
...
confidence intervals of estimates is presented in table 3.

\includegraphics{fertilityEstimates.pdf}
...
child-bearing lead to an increase in wages and hours worked.  Similarly,
\citet{Lundborgetal2014} report considerable and long-lasting effects of
extensive margin fertility on hourly earnings, using IVF success to drive
estimates.
...
other effect on (prospective) mothers' outcomes of interest, beyond its direct 
...
reproductive technologies in many parts of the world.  Similarly, advances in
and diffusion of life saving technologies for mothers and children will drive
broad changes in fertility patterns in other parts of the world.  Given the
importance of mortality reductions as an engine for declines in fertility, as
developing countries continue along the demographic transition, even small
direct effects of fertility on individual and family outcomes will have large
aggregate effects. The interpretation of how these broad demographic shifts
affect family outcomes will require an extension of the existing estimates
and techniques to new life circumstances and situations.  
%R1
...
\newpage
\textbf{Acknowledgements:} I thank Sonia Bhalotra, Paul Devereux,
James Fenske and Margaret Stevens for their many useful comments
