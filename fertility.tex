...
%===============================================================================
\title{Causality and Fertility\thanks{I thank Sonia Bhalotra, Paul Devereux and
James Fenske for their useful comments and extended discussions.}}
...
inferences regarding the effect of child birth on family outcomes is complicated 
by these endogenous factors.  This review article outlines the identification of 
causal estimates of fertilty, and the assumptions underlying the range of 
estimators and methodologies proposed in the economic literature.  A number of
pitfalls are discussed, as well as their potential to bias our interpretation
of the effect additional births have on children and parents.
\end{abstract}
...
fertile-aged women \citep{Darroch2013}. This review article examines the effect 
...
paper, and indeed the literature on which it is based, largely focuses on 
...
motivate causality in each case.  I also discuss common threats to inference
in each case, and what, if anything, these threats imply with regards to the
...
be necessarily pointed.  As such, this article firmly focuses on the effects
...
development may be reversed at some point). We return to provide more details on 
these estimates in the sections which follow.
...
this review paper.  Among those that \emph{do} directly estimate the effect
...
%-------------------------------------------------------------------------------
\section{Conclusion}
This review article serves to provide an overview of the causal estimation of 
...
\includegraphics[scale=0.55]{./figures/timeline.png}
\end{figure}
\floatfoot{Test.}
\end{landscape}
